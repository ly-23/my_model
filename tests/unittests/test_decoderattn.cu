...
int main(int argc, char *argv[])
{
    ...
    // params.max_position_embeddings = max_position_embeddings;                                                                                    
    // params.use_dynamic_ntk = false;                                                                                                              
    launchdecoderattn(qkv, qkv_weight, layer_id, kcache, vcache, finished, step, mha_output);                                       
    ...
    for(int i=0;i<batch_size*num_heads*head_size;i++){
        printf("cpuout为：%f,gpuout为:%f\n",CPU_output[i],h_o[i]);
    }
    // if (is_true)                                                                                                                                 
    // {                                                                                                                                            
    //     printf("test passed\n");                                                                                                                   
